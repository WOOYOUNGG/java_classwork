...
public class CastingTest {	//데이터의 형식을 변환(Type Casting)을 연습한다.
// 필요한 이유 : 대입, 연산(사칙연산 등)을 실행할 때 같은 형식으로 일치를 시켜야 한다.(자동변환 또는 강제변환)

	public static void main(String[] args) {
		
		short sval1 = 11;	// *int 보다 작은 크기의 리터럴은 없음. 11은 4바이트, sval1변수는 2바이트 -> 자동캐스팅
//		sval1 = 40000;		//오류
//		sval1 = sval1 + sval1;	// *4바이트로 연산하기 때문에 오류가 생김. 강제로 캐스팅 필요하다.
//		 ㄴ2바이트	        ㄴ4바이트		
