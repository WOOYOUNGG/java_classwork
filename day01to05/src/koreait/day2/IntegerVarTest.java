...
public class IntegerVarTest {	//정수를 저장하는 변수 연습.
	...
	//		변수 선언한다 -> 변수명과 데이터 형식을 지정하는 것 -> 메모리에 공간 할당된다.
	
	public static void main(String[] args) {
		//지역변수
		byte n1;	//데이터형식:byte, 변수명:n1
		short n2;	//데이터형식:short, 변수명:n2
		int n3;
		long n4;
		
//변수 선언할 때에는 기본형 타입(primitive) 사용한다.
...
//		n3 = 4000000000;	//40억, 오류 : overflow
		n4 = 4000000000L;	//long 형식의 데이터는 뒤에 L(대, 소문자 상관없음)을 표기한다.
		
		//변수의 사용 : 출력/입력, 연산 등
		n3 = n3 + 100;		//n3 변수의 값이 덧셈 결과 값으로 변경된다.
		
		System.out.println("변수n1 = " + n1);		// +는 연결기호
		...
		//short 연산시 주의
		short result;
//		result = n2 + 100;	//->오류	//100은 기본적으로 int형식 4바이트이고
