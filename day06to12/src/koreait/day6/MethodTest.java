...
public class MethodTest {
	...
	//static : 정적인(고정된), static끼리 사용
	public static void main(String[] args) {
		System.out.println(); 	//System은 클래스. out은 (객체형)필드, println은 out의 메소드
		
		//메소드 실행 - 메소드 이름 호출합니다.
		testMethod1();	//main메소드의 툭징 : static, 실행할 수 있는 메소드는 static만 가능합니다.
		testMethod1();
//		testMethod2(123, 123); ->오류 : 두 번째 인자의 형식이 틀림
	...
	//1.인자(args), 반환값 없는 메소드(void) 입니다.
	static void testMethod1() {		//메소드 정의 연습1)		//메소드와 함수는 성격이 동일합니다.
	...
	static void testMethod22(double a,int b,double c ) {
		System.out.println("인자 값 합계="+(a+b+c));		//실수값 + 정수값 = 실수값
	}
