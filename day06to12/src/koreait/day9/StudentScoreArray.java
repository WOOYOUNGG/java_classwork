...
//StudentScore 클래스의 배열을 연습합니다.
	public static void main(String[] args) {
		...
		//입력&배열에 저장된 객체에서 name 필드만 모두 출력해봅니다.
		...
		for(int i=0;i<iclass.length;i++) {
			DecimalFormat df = new DecimalFormat("###.##");		//출력형식을 지정합니다. #하나가 한 자리수
			String avg = df.format(iclass[i].avg());			//***중요!!****출력형식을 적용하여 문자열로 변환합니다.
...
//전역변수(클래스 필드)는 초기값이 참조타입은 null, 기본형타입은0 또는 0.0 자동으로 저장됩니다.
}