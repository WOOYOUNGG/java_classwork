...
public class StringMethod2 {
	...
	public static void main(String[] args) {
		...
		//1.indexOf : contains 처럼 특정 문자열을 찾아서 시작 위치 값을 반환.
		String msg = "koreait.2021@gmail.com";
		System.out.println("gmail의 시작 위치 :"+msg.indexOf("gmail"));
		System.out.println("gmail의 시작 위치 :"+msg.indexOf("naver"));	//반환값은? 해당 문자열이 없을 때 -1
		...
		System.out.println("com으로 끝나는가?"+msg.endsWith("mail"));		
		...
		System.out.println("java 추출 : "+msg.substring(7));
		//문제 : like 추출하려면 substring 메소드 인자는?
		temp = msg.substring(2,6);
		System.out.println("like추출 : "+msg.substring(2,6));
		...
		temp = msg.replaceAll("2021", "1999");		//인자 2개 - 첫 번째 찾는 문자열, 두 번째는 바꿀 문자열 입니다.
		...
		while(true) {
			...
			if(idx==-1) break;
			cnt++;
			temp=temp.substring(idx+find.length());	//치킨은 length가 2 -> 첫 번째 치킨 뒤부터 문자열 추출.
		}
