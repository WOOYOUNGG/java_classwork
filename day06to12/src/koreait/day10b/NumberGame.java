...
public class NumberGame {
		...
		private boolean isSuccess;	//맞추기 성공 여부, 초기값 false
		...
		public static int makeNumber(int min, int max) {	//101~299 : 난수의 최대값, 최소값 인자로 받고 난수 반환
			Random r = new Random();
		...
		public boolean isSuccess() {	//타입이 boolean일 때 isXXX(gerXXX아닙니다.)
			return isSuccess;
		}
