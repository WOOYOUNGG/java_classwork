...
//EnlishKoreanNote클래스는 WordNote 인터페이스 규칙(추상메소드)을 따르고 그의 그룹이 됩니다.
public class EnglishKoreanNote implements WordNote { //영한단어장
	...
	public void start() {
		...
		while (run) {
			...
			String filename;  //="C:\\dev\\mydict.txt";
			switch (sel) {
			case "1":
				wordAdd();
				break;
	...
	//2.WordNote인터페이스의 추상메소드 4개를 구현했습니다.
	public void wordAdd() { // **추상메소드 public이므로 구현 메소드도 public만 가능합니다.**
