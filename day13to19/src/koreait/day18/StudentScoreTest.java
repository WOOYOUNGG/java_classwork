...
public class StudentScoreTest {
	...
	public static void main(String[] args) {
		...
		int num = Integer.parseInt(sc.nextLine());	// parseInt()를 사용하면 타입이 String에서 int로 바뀌기 때문에 당연히 int타입의 변수에 저장해야 된다.
		...
		for(StudentScore score : stus) {   //for문 실행은 10번(배열의 크기만큼) num<10 일때 오류 발생합니다.	//향상된 for문 (https://jamesdreaming.tistory.com/105)참고
