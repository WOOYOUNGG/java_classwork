...
//자바의 CharSequenceTest라는 인터페이스를 연습합시다. 인터페이스의 활용 예시입니다.
	...
	public static void main(String[] args) {
		...
		//문자열을 다루는 클래스입니다. 문자열 연결할 때 +대신에 append메소드를 사용합니다.
		...
		names = new Vector<>();		//ArrayList 보다 List로 했을 때 장점: 같은 변수 명으로 다른 구현 객체를 참조할 수 있습니다.
