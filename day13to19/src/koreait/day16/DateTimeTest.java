...
public class DateTimeTest {
	...
	public static void main(String[] args) {
		...
		LocalDate mybirth = LocalDate.of(1996, 1, 7);
		...
		day=30;
		System.out.println("오늘 날짜+" +day+"일전 은 "+currentDate.minusDays(5));
		
		//내가 태어난지 며칠이 지났는지.(날짜 사이의 간격 계산)
		Period between = Period.between(mybirth, currentDate);
		
		System.out.println("내가 태어난지 "+ between.getYears()+"년");
		System.out.println("내가 태어난지 "+ between.getMonths()+"개월(달)");
		...
		//Duration 클래스 : 시간 간격 계산할 때 사용 메소드 있습니다.
